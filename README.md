# Final_vton_workflow_with_old_models_without_subgraphs
ComfyUI workflow Dockerized via [comfyui-wizard](https://comfy.getrunpod.io).
Submission: https://comfy.getrunpod.io/dashboard/submissions/kd7agn23qx19fjek7mc5xmaxyd89p6rr
## Pull the prebuilt image

We've already built and published this image on Docker Hub:

```bash
docker pull timpietruskyrunpod/comfyui-wizard:kd7agn23qx19fjek7mc5xmaxyd89p6rr
docker run --rm --gpus all -p 8188:8188 timpietruskyrunpod/comfyui-wizard:kd7agn23qx19fjek7mc5xmaxyd89p6rr
```
